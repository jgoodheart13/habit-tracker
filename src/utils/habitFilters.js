...
export function isHabitUrgent(habit, activeDate, weekDays) {
  ...
  return completionsRemaining >= daysRemainingInWeek
}
 ...
 */
export function sortUrgentHabits(habits, weekDays) {
  return habits.sort((a, b) => {
    const completedA = weekDays.filter((d) => a.completedDates.includes(d))
      .length
    const completedB = weekDays.filter((d) => b.completedDates.includes(d))
      .length
